...
ASSOC=/cellar/users/mpagadal/projects/germline-immune/data/plink-associations/plink_cancer_associations
...
/cellar/users/mpagadal/Programs/plink2 --bfile $GENO --pheno $PHENO --pheno-name $pheno --covar $COVAR --extract $EXTRACT --keep $KEEP --covar-name C1-C10,age --covar-variance-standardize --glm firth-fallback sex cols=+err --out $ASSOC/$pheno\_$canc
